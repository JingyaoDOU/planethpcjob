#!/bin/bash
#SBATCH -J PLANETimpact_0d0h_0d99640_npt222272_1d99281_v15d3600kms_b0d700_pX
...
~/yq/yq_linux_386 -i '.InitialConditions.file_name="PLANETimpact_0d0h_0d99640_npt222272_1d99281_v15d3600kms_b0d700_pX.hdf5"' parameters_impact.yml
...
cat parameters_impact.yml >> ./logput_PLANETimpact_0d0h_0d99640_npt222272_1d99281_v15d3600kms_b0d700_pX.txt

/user/home/qb20321/hammer/toolkit/swift_subtask -a -s -G -t 32 ./parameters_impact.yml 2>&1 | tee -a ./logput_PLANETimpact_0d0h_0d99640_npt222272_1d99281_v15d3600kms_b0d700_pX.txt

cp output_30h_36000dt/snapshot_0003.hdf5 snapOUT_PLANETimpact_0d0h_0d99640_npt222272_1d99281_v15d3600kms_b0d700_pX.hdf5
